...
class HashtagsControllerTest < ActionController::TestCase
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post :create, hashtag: { date_publish_hashtag: @hashtag.date_publish_hashtag, hashtag_content: @hashtag.hashtag_content, num_mentions_hashtag: @hashtag.num_mentions_hashtag, official: @hashtag.official }
    end
  ...
  test "should update hashtag" do
    patch :update, id: @hashtag, hashtag: { date_publish_hashtag: @hashtag.date_publish_hashtag, hashtag_content: @hashtag.hashtag_content, num_mentions_hashtag: @hashtag.num_mentions_hashtag, official: @hashtag.official }
    assert_redirected_to hashtag_path(assigns(:hashtag))
  end
