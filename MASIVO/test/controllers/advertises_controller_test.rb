...
class AdvertisesControllerTest < ActionController::TestCase
  ...
  test "should create advertise" do
    assert_difference('Advertise.count') do
      post :create, advertise: { account_id: @advertise.account_id, date_end_advertise: @advertise.date_end_advertise, date_origin_advertise: @advertise.date_origin_advertise, event_id: @advertise.event_id }
    end
  ...
  test "should update advertise" do
    patch :update, id: @advertise, advertise: { account_id: @advertise.account_id, date_end_advertise: @advertise.date_end_advertise, date_origin_advertise: @advertise.date_origin_advertise, event_id: @advertise.event_id }
    assert_redirected_to advertise_path(assigns(:advertise))
  end
